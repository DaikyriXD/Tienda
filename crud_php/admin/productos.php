    ...
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-hover table-bordered" style="width: 100%;">
                ...
                <tbody>
                    <?php
                    $query = pg_query($dbconn, "SELECT p.*, c.id AS id_cat, c.categoria FROM productos p INNER JOIN categorias c ON c.id = p.id_cat ORDER BY p.id DESC");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php 
                                $categorias = pg_query($dbconn, 'SELECT * FROM categorias');

                                while ($data = pg_fetch_assoc($categorias)) {
