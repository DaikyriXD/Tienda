            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <?php
                        $query = pg_query($dbconn, "SELECT * FROM categorias");
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">Encuentra los mejores pruductos al mejor precio.</p>
            </div>
        </div>
    </header>
    <section class="py-5">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <?php
                $query = pg_query($dbconn, "SELECT p.*, c.id As id_catt, c.categoria FROM productos p INNER JOIN categorias c ON c.id = p.id_cat");
